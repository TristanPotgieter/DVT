internal partial class Program
{
    private static void Main(string[] args)
    {
        ...
        var elevatorCount = InputInterger("Please enter how many elevators your building has.");
        var elevatorCapacity = InputInterger("Please enter how many people each elevator can carry.");
        var floorCount = InputInterger("Please enter how many floors your building has.");
    ...
    private static int InputInterger(string message)
    {
        while (true)
        {
    ...
    private static IEnumerable<Elevator> SetElevatorStartPositions(int numberOfElevators, int elevatorCapacity, int numberOfFloors)
    {
        ...
        {
            var elevatorFloor = InputInterger($"On which floor is elevator {counter + 1}");
    ...
    private static Dictionary<int, Floor> SetFloorStates(int numberOfFloors)
    {
        var counter = 0;
        ...
        {
            var peopleWaiting = InputInterger($"How many people are waiting on floor number {counter}");
